...
class UpdatePaymentMethodRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'type' => 'sometimes|required|in:Cash,QRIS,E-Wallet,Bank Transfer,Credit Card,Debit Card',
            'fee_type' => 'sometimes|required|in:None,Fixed Amount,Percentage',
            'fee_value' => 'sometimes|required|numeric|min:0',
